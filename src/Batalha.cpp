...
void desenhar(){
   ...
   // al_draw_scaled_bitmap(base, 0, 0, 1920, 1080, 790, 100, 20020*(res_x_comp/1920.0), 11000*(res_y_comp/1080.0), 0);
    al_draw_scaled_bitmap(billy_batalha, 0, 0, 1920, 1080, 0, 0, 2320*(res_x_comp/1920.0), 1480*(res_y_comp/1080.0), 0);
    //al_draw_scaled_bitmap(base, 0, 0, 1920, 1080, 220, 230, 20020*(res_x_comp/1920.0), 11000*(res_y_comp/1080.0), 0);
    al_draw_scaled_bitmap(player_batalha, 0, 0, 1920, 1080, 0, 0,  2320*(res_x_comp/1920.0), 1480*(res_y_comp/1080.0), 0);
