...
void Batalha1x1::batalhar(){
    ...
    while (1)
    {
        ...
        al_draw_scaled_bitmap(base_pistoleiro, 0, 0, 1920, 1080, 770, 50, 20020*(res_x_comp/1920.0), 11000*(res_y_comp/1080.0), 0);
        ...
        al_draw_scaled_bitmap(vida_vilao, 0, 0, 1920, 1080, 0, 80, 1920*(res_x_comp/1920.0), 1080*(res_y_comp/1080.0), 0);
